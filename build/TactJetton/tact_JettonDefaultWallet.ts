...
export function loadTokenUpdateContent(slice: Slice) {
    ...
    let _queryId = sc_0.loadUintBig(64);
    let _content = sc_0.loadRef();
    return { $$type: 'TokenUpdateContent' as const, queryId: _queryId, content: _content };
}
...
function loadTupleTakeWalletAddress(source: TupleReader) {
    ...
    let _ownerAddress = source.readCell();
    return { $$type: 'TakeWalletAddress' as const, queryId: _queryId, walletAddress: _walletAddress, ownerAddress: _ownerAddress };
}
...
function storeTupleTakeWalletAddress(source: TakeWalletAddress) {
    ...
    builder.writeSlice(source.ownerAddress);
    return builder.build();
}
...
export function loadEditContent(slice: Slice) {
    let sc_0 = slice;
    if (sc_0.loadUint(32) !== 1010883227) { throw Error('Invalid prefix'); }
    let _queryId = sc_0.loadUintBig(64);
    let _content = sc_0.loadRef();
...
export function loadWithdraw(slice: Slice) {
    let sc_0 = slice;
    if (sc_0.loadUint(32) !== 564068428) { throw Error('Invalid prefix'); }
    let _queryId = sc_0.loadUintBig(64);
    let _to = sc_0.loadMaybeAddress();
    return { $$type: 'Withdraw' as const, queryId: _queryId, to: _to };
}
...
const JettonDefaultWallet_types: ABIType[] = [
    ...
    {"name":"TokenUpdateContent","header":4,"fields":[{"name":"queryId","type":{"kind":"simple","type":"uint","optional":false,"format":64}},{"name":"content","type":{"kind":"simple","type":"cell","optional":false}}]},
    ...
    {"name":"EditContent","header":1010883227,"fields":[{"name":"queryId","type":{"kind":"simple","type":"uint","optional":false,"format":64}},{"name":"content","type":{"kind":"simple","type":"cell","optional":false}}]},
    {"name":"Withdraw","header":564068428,"fields":[{"name":"queryId","type":{"kind":"simple","type":"uint","optional":false,"format":64}},{"name":"to","type":{"kind":"simple","type":"address","optional":true}}]},
]

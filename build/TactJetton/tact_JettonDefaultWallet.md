...
Signature: `TokenBurn{queryId:uint64,amount:coins,response_destination:Maybe address}`
...
## TokenUpdateContent
TLB: `token_update_content#00000004 queryId:uint64 content:^cell = TokenUpdateContent`
Signature: `TokenUpdateContent{queryId:uint64,content:^cell}`
...
## TakeWalletAddress
TLB: `take_wallet_address#d1735400 queryId:uint64 walletAddress:address ownerAddress:remainder<slice> = TakeWalletAddress`
Signature: `TakeWalletAddress{queryId:uint64,walletAddress:address,ownerAddress:remainder<slice>}`

## Mint
TLB: `mint#1f90a0ea queryId:uint64 amount:coins receiver:address = Mint`
Signature: `Mint{queryId:uint64,amount:coins,receiver:address}`

## EditContent
TLB: `edit_content#3c40da9b queryId:uint64 content:^cell = EditContent`
Signature: `EditContent{queryId:uint64,content:^cell}`

## Withdraw
TLB: `withdraw#219f004c queryId:uint64 to:Maybe address = Withdraw`
Signature: `Withdraw{queryId:uint64,to:Maybe address}`
